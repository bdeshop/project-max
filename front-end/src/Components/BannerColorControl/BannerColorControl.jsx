...
const BannerColorControl = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/banner`)
      .then((res) => {
        const data = res.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/banner`, {
        bgColor,
        textColor,
...
export default BannerColorControl;