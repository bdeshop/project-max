          ...
          <div className="flex items-center gap-2">
            ...
            >
              <input
                ...
                className="flex-1 px-3 py-2 rounded-md bg-white text-black border border-gray-600 focus:outline-none focus:ring-2 focus:ring-red-400 placeholder-gray-300"
                disabled={loading}
              />
              <button
                type="submit"
                className="px-4 cursor-pointer py-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-md shadow-md transition-all duration-200"
                disabled={loading}
              >
                {loading ? "Adding..." : "Add +"}
              </button>
