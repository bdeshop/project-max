...
const ProfitLossReportByCasinoDownLine = () => {
      ...
      <div className="w-[90%] bg-white border border-gray-300 rounded-md shadow-sm">
        ...
        <div className="px-4 py-5 bg-gray-50">
          <div className="flex items-center gap-2">
            ...
            <button className="bg-red-600 text-white px-3 py-1 text-sm rounded hover:bg-red-700 transition">
              Get P & L
            </button>
          </div>

          <div className="flex gap-2 mt-4 px-2 py-1 border rounded-lg border-gray-400 items-center w-48 mb-4">
...
export default ProfitLossReportByCasinoDownLine;